...
<body>
    ...
    <section class="hero-slider">
        <div class="hero-items owl-carousel">
            <div class="single-slider-item set-bg" data-setbg="{{ url('public') }}/img/home4.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2022</h1>
            ...
            <div class="single-slider-item set-bg" data-setbg="{{ url('public') }}/img/slider-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2022</h1>
            ...
            <div class="single-slider-item set-bg" data-setbg="{{ url('public') }}/img/slider-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>2022</h1>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-features-ads first">
                            <img src="{{ url('public') }}/img/icons/f-delivery.png" alt="">
                            <h4>Free shipping</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="single-features-ads second">
                            <img src="{{ url('public') }}/img/icons/coin.png" alt="">
                    ...
                    <div class="col-lg-4">
                        <div class="single-features-ads">
                            <img src="{{ url('public') }}/img/icons/chat.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row" id="product-list">
                ...
                <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/img/gmbr 6.jpg" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6 mix all dresses bags">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/img/gmbr 2.jpg" alt=""></a>
                ...
                <div class="col-lg-3 col-sm-6 mix all shoes accesories">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/img/gmbr 5.jpg" alt=""></a>
                            <div class="p-status">new</div>
                        </figure>
                        <div class="product-text">
                ...
                <div class="col-lg-3 col-sm-6 mix all shoes accesories">
                    <div class="single-product-item">
                        <figure>
                            <a href="#"><img src="{{ url('public') }}/img/gmbr 8.jpg" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="lookbok-pic">
                        <img src="{{ url('public') }}/img/gmbr 1.jpg" alt="">
    ...
    <div class="logo-section spad">
        <div class="logo-items owl-carousel">
            <div class="logo-item">
                <img src="{{ url('public') }}/img/logos/logo-1.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/img/logos/logo-2.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/img/logos/logo-3.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/img/logos/logo-4.png" alt="">
            </div>
            <div class="logo-item">
                <img src="{{ url('public') }}/img/logos/logo-5.png" alt="">
            </div>
        </div>
    </div>
    <!-- Logo Section End -->
